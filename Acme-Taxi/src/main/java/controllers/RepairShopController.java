...
public class RepairShopController extends AbstractController {
	...
	public ModelAndView list(final HttpServletRequest request) {
		...
		res.addObject("requestURI", "repairShop/list.do");
		return res;
	}
	...
	//Searching
		...
		public ModelAndView search() {
			ModelAndView res;
			res = new ModelAndView("repairShop/search");
			return res;
		}

		@RequestMapping(value = "/list-search", method = RequestMethod.GET)
		public ModelAndView searchList(String keyword,final HttpServletRequest request) {
			ModelAndView res;
			Collection<RepairShop> repairShops;
			Pageable pageable;
			Direction dir = null;
			...
			if (sortAtt != null && dir != null)
				...
				pageable = new PageRequest(pageNum, 5);
			final Integer total = this.repairShopService.countByKeyword(keyword);
			repairShops = this.repairShopService.listByKeyword(keyword, pageable);
			res = new ModelAndView("repairShop/list");
			res.addObject("repairShops", repairShops);
			res.addObject("total", total);
			res.addObject("requestURI", "repairShop/list-search.do");
			return res;
		}
}
