...
<jstl:if test="${requestURI == 'repairShop/list.do' }">
...
<jstl:if test="${requestURI == 'repairShop/driver/select.do' }">
<display:column>
			<a href="car/driver/select-shop.do?repairShopId=${row.id}"> <spring:message
					code="repairShop.select" />
			</a>
