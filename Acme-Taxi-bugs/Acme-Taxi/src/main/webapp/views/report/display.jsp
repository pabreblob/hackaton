...
<div style="margin-left: auto; margin-right: auto; position: center; display: block; width:50%; border: black solid 1px;">
	...
	<p style="margin-left:2%;"><b><spring:message code="report.writtenBy"/></b><jstl:out value="${report.reported.name}"/> <jstl:out value="${report.reported.surname}"/> (<a href="actor/display.do?actorId=${report.reported.id}"><jstl:out value="${report.reported.userAccount.username}"/></a>)</p>
